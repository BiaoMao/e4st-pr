function mpc = t_case30_e4st_caplim
%T_CASE30_E4ST_CAPLIM   Modified case30.m for E4ST.
...
mpc.gen = [
	1	5.88	0	15	-10	1	100	1	20	0	0	20	-14	18	-6	8	100	100	100	0	0;
	1	10.3	0	26.25	-17.5	1	100	1	35	0	0	35	-24.5	31.5	-10.5	14	100	100	100	0	0;
	2	19.05	0	18.75	-12.5	1	100	1	25	0	0	25	-17.5	22.5	-7.5	10	100	100	100	0	0;
	2	22.87	0	22.5	-15	1	100	1	30	0	0	30	-21	27	-9	12	100	100	100	0	0;
	22	12.95	0	22.5	-15	1	100	1	30	0	0	30	-21	27	-9	12	100	100	100	0	0;
	22	8.64	0	15	-10	1	100	1	20	0	0	20	-14	18	-6	8	100	100	100	0	0;
	27	17.12	0	26.25	-17.5	1	100	1	35	0	0	35	-24.5	31.5	-10.5	14	100	100	100	0	0;
	27	9.79	0	15	-10	1	100	1	20	0	0	20	-14	18	-6	8	100	100	100	0	0;
	23	10.47	0	15	-10	1	100	1	20	0	0	20	-14	18	-6	8	100	100	100	0	0;
	23	18.33	0	26.25	-17.5	1	100	1	35	0	0	35	-24.5	31.5	-10.5	14	100	100	100	0	0;
	13	25.62	0	22.5	-15	1	100	1	30	0	0	30	-21	27	-9	12	100	100	100	0	0;
	13	29.88	0	26.25	-17.5	1	100	1	35	0	0	35	-24.5	31.5	-10.5	14	100	100	100	0	0;
	3	0	0	0	0	1	100	1	10	0	0	0	0	0	0	0	100	100	100	0	0;
	5	0	0	0	0	1	100	1	10	0	0	0	0	0	0	0	100	100	100	0	0;
	8	0	0	0	0	1	100	1	10	0	0	0	0	0	0	0	100	100	100	0	0;
	9	0	0	0	0	1	100	1	10	0	0	0	0	0	0	0	100	100	100	0	0;
	14	0	0	0	0	1	100	1	10	0	0	0	0	0	0	0	100	100	100	0	0;
	17	0	0	0	0	1	100	1	10	0	0	0	0	0	0	0	100	100	100	0	0;
	18	0	0	0	0	1	100	1	10	0	0	0	0	0	0	0	100	100	100	0	0;
	20	0	0	0	0	1	100	1	10	0	0	0	0	0	0	0	100	100	100	0	0;
	10	0	0	0	0	1	100	1	10	0	0	0	0	0	0	0	100	100	100	0	0;
	24	0	0	0	0	1	100	1	10	0	0	0	0	0	0	0	100	100	100	0	0;
	26	0	0	0	0	1	100	1	10	0	0	0	0	0	0	0	100	100	100	0	0;
	30	0	0	0	0	1	100	1	10	0	0	0	0	0	0	0	100	100	100	0	0;
% dispatchable loads
...
mpc.if.map = [
	1	-12;	%% 1 : area 1 imports, 10 -> 6
	1	-14;	                    %% 10 -> 9
	1	-15;	                    %% 12 -> 4
	1	-36;	                    %% 27 -> 28
	2	15;	%% 2 : area 2 imports,  4 -> 12
	2	25;	                    %% 10 -> 20
	2	26;	                    %% 10 -> 17
	2	-32;	                    %% 24 -> 23
	3	12;	%% 3 : area 3 imports,  6 -> 10
	3	14;	                    %%  9 -> 10
	3	-25;	                    %% 20 -> 10
	3	-26;	                    %% 17 -> 10
	3	32;	                    %% 23 -> 24
...
% ];
mpc.if.lims = [
	1	-15	75;	%% area 1 imports
	2	-40	20;	%% area 2 imports
];

%%-----  Emission Constraint Data  -----%%
ng = size(mpc.gen, 1);
mpc.total_output.map = zeros(3, ng);
mpc.total_output.map(1, [1:4 13:16])  = 1;      %% area 1
mpc.total_output.map(2, [9:12 17:20]) = 1;      %% area 2
mpc.total_output.map(3, [5:8 21:24])  = 1;      %% area 3
mpc.total_output.cap = [100; 90; 9.5];
mpc.total_output.coeff = zeros(ng, 2);
mpc.total_output.coeff(1:24, 1) = 1;
mpc.total_output.coeff(1:24, 2) = 0.1;
...
mpc.caplim.map = zeros(2, ng);
mpc.caplim.map(1, 13:2:24) = 1;
mpc.caplim.map(2, 14:2:24) = 1;
mpc.caplim.max = [30; 40];
mpc.caplim.min = [16; 0];
